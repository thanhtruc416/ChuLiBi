...
class Frame06(Frame):
    def __init__(self, parent, controller):
        ...
        canvas.create_text(544.0, 335.0, anchor="nw", text="Customer group with the highest spending", fill="#B992B9",
        ...
        canvas.create_text(560.0, 674.0, anchor="nw", text="Order Trends by Age Group", fill="#B992B9",
                           font=("Crimson Pro", 18 * -1))
        canvas.create_text(999.0, 659.0, anchor="nw", text="Pie chart", fill="#706093", font=("Young Serif", 27 * -1))
        canvas.create_text(1135.0, 673.0, anchor="nw", text="Proportion of Meal Types", fill="#B992B9",
                           font=("Crimson Pro", 18 * -1))
